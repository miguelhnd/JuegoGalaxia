...
public class EscenarioJupiter extends JPanel implements ActionListener, KeyListener
{
    // Atributos 
    ...
    // Constructores
    public EscenarioJupiter(JFrame marco, int habi, boolean conquistado)
    {
        this.marco=marco;
        this.y=0;
        this.x=0;
        Icono=new ImageIcon("Imagenes/FondoJupiter.jpg");
        ...
        {
            NaveE2=new NaveEnemiga2(700,r.nextInt(500)-1000);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        { 
                ...
                for(int i=0; i<Enemigos.length; i++)
                {
                    ...
                    for(int j=0; j<BalaHumano.length; j++)
                    {
                       if(BalaHumano[j].detectar(Enemigos[i].getRectangle()))
                       {
                           ...
                           if(this.VidasEnemigas==0)
                           {
                               JOptionPane.showMessageDialog(null,"Planeta Jupiter conquistado. Has ganado 10 puntos.");
                               Puntajes.setConquistas(1);
                               Puntajes.setPuntaje(10);
                               new Principal(this.marco,2,"PlanetaJupiter"); 
                               comprobar=false;
                           }
                       }
            ...
            {
                JOptionPane.showMessageDialog(null,"Planeta Jupiter deshabitado. Has ganado 10 puntos.");
                Puntajes.setConquistas(1);
                Puntajes.setPuntaje(10);
                new Principal(this.marco,2,"PlanetaJupiter"); 
                comprobar=false;
