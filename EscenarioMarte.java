...
public class EscenarioMarte extends JPanel implements ActionListener, KeyListener
{
    // Atributos 
    ...
    // Constructores
    public EscenarioMarte(JFrame marco, int habi, boolean conquistado)
    {
        this.marco=marco;
        this.y=0;
        this.x=0;
        Icono=new ImageIcon("Imagenes/FondoMarte.jpg");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        { 
                ...
                for(int i=0; i<Enemigos.length; i++)
                {
                    ...
                    for(int j=0; j<BalaHumano.length; j++)
                    {
                       if(BalaHumano[j].detectar(Enemigos[i].getRectangle()))
                       {
                           ...
                           if(this.VidasEnemigas==0)
                           {
                               JOptionPane.showMessageDialog(null,"Planeta Marte conquistado. Has ganado 10 puntos.");
                               Puntajes.setConquistas(1);
                               Puntajes.setPuntaje(10);
                               new Principal(this.marco,1,"PlanetaMarte"); 
                               comprobar=false;
                           }
                       }
            ...
            {
                JOptionPane.showMessageDialog(null,"Planeta Marte deshabitado. Has ganado 10 puntos.");
                Puntajes.setConquistas(1);
                Puntajes.setPuntaje(10);
                new Principal(this.marco,1,"PlanetaMarte"); 
                comprobar=false;
